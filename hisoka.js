...
➥ Detail: ${detail}`
            ...
            case 'list': case 'menu': case 'help': case '?': {
                anu = ` *Haik Minna san, konnichiwa/konbanwa 😇😇*,*  ini adalah shizuka bot kwkwkw, kalau kamu suka sama shizuka bot, jangan lupa follow ig @alfando_3398 ya gays 🙃, dan kalau semisal ada bug atau semcamnya, chat aja wa.me/6285764175824
                
*berikut list menu nya🗿*
...
└───────⭓`
                let btn = [{
                                ...
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: 'wa.me/6285764175824'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Status Bot',
